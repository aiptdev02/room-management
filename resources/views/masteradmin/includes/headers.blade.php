<div class="logo text-center py-2 border-bottom">
    <a href=""></a>
</div>

<div class="nav-header">
    <a href="{{ url('/dashboard') }}" class="brand-logo mt-3">
        <img src="{{ asset('assets/images/logo.png') }}" class="img-fluid" style="width: 150px;" alt="Logo">
    </a>
...
<div class="deznav pt-3">
    <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li>
                <a href="{{ route('paying-guests.index') }}">
                    <div class="menu-icon">
            ...
            <li>
                <a href="{{ route('rent_collections.index') }}">
                    <div class="menu-icon">
                        <i class="fas fa-users"></i>
                    </div>
                    <span class="nav-text">Rent Collections</span>
                </a>
            </li>

            @if (Auth::guard('masters')->user()->type === 'master')
                <li>
                    <a href="{{ route('masters.indexList') }}">
                        <div class="menu-icon">
                            <i class="fas fa-users"></i>
                        </div>
        ...
        <div class="copyright">
            <p>Copyright © Room Management - All Rights Reserved</p>
        </div>
    </div>
</div>
