                                    ...
                                    <div class="card border-0 mb-0">
                                        <div class="card-header py-2">
                                            <div class="products">
                                                ...
                                                <div>
                                                    <h6>{{ Auth::guard('masters')->user()->name }}</h6>
                                                    <span>{{ Auth::guard('masters')->user()->username }}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-body px-0 py-2">
                                            <a href="{{ url('update-profile') }}" class="dropdown-item ai-icon ">
                                        ...
                                        <div class="card-footer px-0 py-2">
                                            ...
                                            <a href="#" class="dropdown-item ai-icon" id="logout">
